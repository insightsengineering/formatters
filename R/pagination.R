...
#'
#' Given `lpp` (`cpp`) already adjusted for rendered elements which are not rows/columns and a
#' dataframe of pagination information, pagination is performed via the following algorithm,
#' and with a `start = 1`:
#'
