## formatters 0.5.4.9004
 * Applied `styler` and resolved package lint. Changed default indentation from 4 spaces to 2.
 * Fixed wrapping and section dividers error.
 * Allowed section divider between header and table body.
 * Added the possility of setting a general default using `set_default_hsep()` that sets up the option `getOption("formatters_default_hsep")`.
